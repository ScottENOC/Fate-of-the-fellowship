...
const LOCS = {
  'grey-havens':    { name:'Grey Havens',    x: 8, y:30, region:'eriador',           isHaven:true,  musterType:'elven',    startShadow:0, capturable:false },
  'ered-luin':      { name:'Ered Luin',      x: 8, y:24, region:'eriador',           isHaven:false, musterType:'dwarven',  startShadow:0, capturable:false },
  'the-shire':      { name:'The Shire',      x:14, y:27, region:'eriador',           isHaven:true,  musterType:null,       startShadow:0, capturable:false },
  'bree':           { name:'Bree',           x:21, y:30, region:'eriador',           isHaven:false, musterType:null,       startShadow:0, capturable:false },
  ...
  'southern-mirkwood':{ name:'Southern Mirkwood', x:64.52, y:35.64, region:'rhovanion', isHaven:false, musterType:null, startShadow:0, capturable:false },
  ...
  'dagorlad':       { name:'Dagorlad',       x:68.72, y:48.8, region:'rhovanion',     isHaven:false, musterType:null,       startShadow:0, capturable:false },
  ...
  'woodland-realm': { name:'Woodland Realm', x:57, y:20, region:'rhovanion',         isHaven:true,  musterType:'elven',    startShadow:0, capturable:false },
  ...
  'erebor':         { name:'Erebor',         x:66.36, y:20.72, region:'rhovanion',   isHaven:false, musterType:'dwarven',  startShadow:0, capturable:false },
  ...
  'dorwinion':      { name:'Dorwinion',      x:76.8, y:33.4, region:'rhovanion',     isHaven:false, musterType:null,       startShadow:0, capturable:false },
  ...
  'helms-deep':     { name:"Helm's Deep",    x:40.4, y:52.32, region:'rohan',        isHaven:false, musterType:'rohirrim', startShadow:0, capturable:false },
  ...
  'dol-amroth':     { name:'Dol Amroth',     x:41.28, y:67.56, region:'gondor',      isHaven:false, musterType:'gondor',   startShadow:0, capturable:false },
  'pelargir':       { name:'Pelargir',       x:55.92, y:67, region:'gondor',         isHaven:false, musterType:'gondor',   startShadow:0, capturable:false },
  ...
  'minas-morgul':   { name:'Minas Morgul',   x:70.2, y:65.04, region:'mordor',       isHaven:false, musterType:null,       startShadow:2, capturable:false },
  'udun':           { name:'Udûn',           x:67.44, y:54.4, region:'mordor',        isHaven:false, musterType:null,       startShadow:0, capturable:false },
  'barad-dur':      { name:'Barad-dûr',      x:76.68, y:54.68, region:'mordor',      isHaven:false, musterType:null,       startShadow:2, capturable:false },
  ...
  'near-harad':     { name:'Near Harad',     x:69.16, y:87.28, region:'haradwaith',  isHaven:false, musterType:null,       startShadow:2, capturable:false },
  'umbar':          { name:'Umbar',          x:58.4, y:88.68, region:'haradwaith',   isHaven:false, musterType:null,       startShadow:1, capturable:true  },
...
const CONNECTIONS = [
  ...
  // Red
  { a:'minas-morgul',  b:'minas-tirith',      type:'normal' },
  // Green4 – Anduin
...
const BATTLE_LINES = [
  ...
  { id:'yellow-e', color:'#c8b800', name:'Mordor Line',      locs:['moria','gladden-fields','dol-guldur','southern-mirkwood','dagorlad','north-ithilien','osgiliath','minas-tirith'] },
  ...
  { id:'orange-e', color:'#c07010', name:'Rhovanion Line',   locs:['rhun','dorwinion','southern-mirkwood','old-forest-road','woodland-realm'] },
  { id:'orange-f', color:'#c07010', name:'Rhovanion Line',   locs:['lake-town','erebor','woodland-realm'] },

  // RED – Gondor Line
  { id:'red',      color:'#b01010', name:'Gondor Line',      locs:['minas-morgul','minas-tirith'] },
...
const OBJECTIVES = [
  ...
  },
  {
    ...
    setup: null,
    setupTroops: 0,
    completeIf: 'Capture Isengard (Capture action after all shadow troops defeated).',
    whenCompleted: 'Gain 2 hope.',
  },
  {
    id: 'challenge-sauron',
